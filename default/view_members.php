...
<td><span style="float:left;margin: 1px;"><form action="edit_member.php?id=<?php echo($qufe['id']); ?>&name=<?php echo($qufe['name']); ?>&course=<?php echo($qufe['course']); ?>&year=<?php echo($qufe['year']); ?>&phone=<?php echo($qufe['phone']); ?>&bl=<?php echo urlencode($qufe['blood']); ?>&campus=<?php echo($qufe['campus']); ?>" method="post"><button type="submit" class="tabledit-edit-button btn btn-primary waves-effect waves-light" style="float: none;margin: 1px;"><span class="icofont icofont-ui-edit"></span></button>
